...
<div class="flex-container" style="display: flex; flex-wrap: wrap; align-items: center; margin-left:50px; margin-right:50px; margin-top:5px; margin-below:25px; box-sizing:border-box; max-width: 1000px">
